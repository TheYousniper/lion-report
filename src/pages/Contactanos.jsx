...
const Contactanos = () => {
  ...
  return (
    <div className="max-w-lg mx-auto my-7 p-6 bg-white rounded-lg shadow-lg">
      ...
      <form>
        <div className="mb-4">
          <label for="name" className="block font-medium text-lion-blue font-helvetic-medium uppercase text-xl">
            Nombre
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label for="email" className="block font-medium text-lion-blue font-helvetic-medium uppercase text-xl">
            Correo Electrónico
          </label>
          <input
            type="email"
        ...
        <div className="mb-4">
          <label for="message" className="block font-medium text-lion-blue font-helvetic-medium uppercase text-xl">
            Mensaje
          </label>
          <textarea
            id="message"
